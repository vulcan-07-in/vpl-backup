...
export default function SquadsClient({ initialData }: { initialData: Team[] }) {
    ...
    return (
        <>
            <main className="min-h-screen pt-24 pb-16 px-4 md:pt-28 bg-black text-white">
                ...
                {selectedTeam && (
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="relative w-full md:max-w-xl bg-zinc-950 border-t md:border md:rounded-2xl overflow-hidden shadow-2xl"
